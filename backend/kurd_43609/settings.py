"""
Django settings for kurd_43609 project.
...
WSGI_APPLICATION = 'kurd_43609.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kurd_43609 API",
    "DESCRIPTION": "API documentation for kurd_43609 App",
    "VERSION": "v1",
}
