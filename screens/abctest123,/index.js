...
const DashboardScreen = () => {
  ...
  return <ScrollView style={styles.container}>
      ...
      <ImageBackground style={styles.FjwHsPud} source={{
      ...
      <View style={styles.chartContainer}>
        <Image source={require("./sean.jpg")} style={styles.chartImage} />
      <Switch style={styles.cZiktzXP}></Switch><RadioGroup style={styles.qFhmOmNS} radioButtons={[{
        id: "1",
        label: "Option 1",
        value: "option1"
      }, {
      ...
      <View style={styles.tableContainer}>
        <View style={styles.tableHeader}>
          <Text style={styles.tableHeaderText}>{"tanya"}</Text>
        </View>
